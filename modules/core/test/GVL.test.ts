...
const vendorlistJson = require('@didomi-testing/lib/vendorlist/v2/vendor-list-v24.json');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const translationJson = require('@didomi-testing/lib/vendorlist/v2/purposes-fr.json');
// eslint-disable-next-line @typescript-eslint/no-var-requires
